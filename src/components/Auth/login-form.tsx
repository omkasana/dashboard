...
export function LoginForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await postRequest<LoginResponse>(AUTH_ROUTES.LOGIN, {
  ...
  return (
    ...
    >
      <FieldGroup>
        ...
        {/* SUCCESS MESSAGE */}
        {success && (
          <div className="rounded-xl border border-green-500/20 bg-green-500/10 px-4 py-3 text-sm text-green-500">
            {success}
          </div>
        )}
