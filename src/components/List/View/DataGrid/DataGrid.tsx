        ...
        <div className="rounded-xl border bg-[var(--background)] border-[var(--border)] shadow-sm overflow-hidden">
            <div className="overflow-x-auto">
                <table className="min-w-full border-collapse text-sm">
                    <thead className="sticky top-0 z-30 bg-[var(--table-header-bg)]">
                        <tr>
                            <th className="w-14 p-4 text-center border-r border-[var(--border)] sticky left-0 bg-[var(--table-header-bg)]">
                                <input
                                    type="checkbox"
                                    checked={
                            ...
                            {columns.map((col) => (
                                <th
                                    key={col.key}
                                    className="px-4 h-11 text-left uppercase text-xs tracking-wide font-semibold text-[var(--muted-foreground)] border-r border-[var(--border)]"
                                >
                                    {col.label}
                                </th>
                            ))}

                            <th className="w-20 text-center uppercase text-xs font-semibold text-[var(--muted-foreground)] border-l border-[var(--border)] p-2 sticky right-0 bg-[var(--table-header-bg)]">
                                Actions
                            </th>
                        </tr>
                    </thead>
